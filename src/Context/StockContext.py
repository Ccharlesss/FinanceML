# SP500 = ['MSFT', 'AAPL', 'NVDA', 'AMZN', 'META', 'GOOGL', 'GOOG', 'BRK.B', 'LLY', 'JPM', 'AVGO', 'XOM', 'UNH', 
...
#         'GE', 'IBM', 'Other', 'VZ', 'CMCSA', 'DHR', 'AMAT', 'COP', 'TXN', 'PM', 'NOW', 'PFE', 'AMGN', 'INTC', 'UNP', 
...
#         'DLR', 'FIS', 'STZ', 'PRU', 'AMP', 'AME', 'JCI', 'URI', 'IQV', 'COR', 'IR', 'PCG', 'DOW', 'CMI', 'PAYX', 'GEV', 
...
#         'BKR', 'CTSH', 'DFS', 'KVUE', 'CDW', 'PWR', 'IT', 'GEHC', 'DD', 'MRNA', 'ED', 'DG', 'ANSS', 'DAL', 'BIIB',
...
#         'NTAP', 'STT', 'HUBB', 'IRM', 'STLD', 'TDY', 'ES', 'BR', 'TTWO', 'APTV', 'IFF', 'VLTO', 'CINF', 'EQR', 'ETR', 
...
#         'ALB', 'SNA', 'ZBRA', 'SJM', 'EMN', 'IP', 'HST', 'HII', 'CCL', 'WRK', 'AMCR', 'FFIV', 'LKQ', 'GEN', 'UDR', 'DGX', 
...
#         'AAL', 'HRL', 'RHI', 'APA', 'BBWI', 'FRT', 'CHRW', 'DVA', 'CTLT', 'IVZ', 'HAS', 'BWA', 'BEN', 'MTCH', 'CZR', 
#         'SOLV', 'WYNN', 'DAY', 'NWSA', 'CPB', 'INCY', 'TPR', 'FOXA', 'BF.B', 'TFX', 'QRVO', 'BXP', 'CPT', 'AIZ', 'ETSY', 
...
CSV_FILE_PATH = "src/StockData/blabla-data.csv"
